...
public class AdditionalBiomesMod {
    ...
    public AdditionalBiomesMod(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = AdditionalBiomesMod.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
